...
@EnableJpaRepositories(
        basePackages = "com.ygh.infra.persistence.account",  // AccountJpaRepository가 위치한 패키지
...
public class AccountDataSourceConfig {
    ...
    @Value("${account.jpa.hibernate.ddl-auto}")
    ...
    public LocalContainerEntityManagerFactoryBean accountEntityManagerFactory() {
        ...
        emf.setDataSource(accountDataSource());
        emf.setPackagesToScan("com.ygh.account");
        ...
        emf.setPersistenceUnitName("account");
        return emf;
    }

    @Bean(name = "accountTransactionManager")
    public PlatformTransactionManager accountTransactionManager(
            @Qualifier("accountEntityManagerFactory") LocalContainerEntityManagerFactoryBean emf) {
